...
class MvtStkServiceImplTest {
    ...
    void setUp() {
        ...
        request = new MvtStkRequest(1L, new BigDecimal("5"), SourceMvtStk.COMMANDE_FOURNISSEUR, 1L);
    ...
    void stockReelArticle_shouldComputeAlgebraicSum_ofAllMovementTypes() {
        ...
        when(mvtStkRepository.findByArticleIdOrderByDateMvtAsc(1L)).thenReturn(mouvements);
    ...
    void stockReelArticle_shouldReturnZero_whenNoMovements() {
        when(articleService.getById(1L)).thenReturn(articleResponse);
        when(mvtStkRepository.findByArticleIdOrderByDateMvtAsc(1L)).thenReturn(List.of());
    ...
    void stockReelArticle_shouldThrowEntityNotFoundException_whenArticleNotFound() {
        ...
        verify(mvtStkRepository, never()).findByArticleIdOrderByDateMvtAsc(any());
    }
